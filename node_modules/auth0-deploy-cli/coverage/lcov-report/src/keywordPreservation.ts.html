...
<head>
    <title>Code coverage report for src/keywordPreservation.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> keywordPreservation.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">7x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { get as getByDotNotation, set as setByDotNotation } from 'dot-prop';
...
&nbsp;
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (identifierFieldValue === undefined) <span class="cstat-no" title="statement not covered" >return null; </span>// See if this specific array item possess the resource-specific identifier
&nbsp;
            if (aggregateAddress === '') {
...
&nbsp;
        return getPreservableFieldsFromAssets(
          ...
          `${address}${shouldRenderDot ? '.' : <span class="branch-1 cbranch-no" title="branch not covered" >''}</span>[${specificAddress}]`
        );
      })
      .flat();
  }
