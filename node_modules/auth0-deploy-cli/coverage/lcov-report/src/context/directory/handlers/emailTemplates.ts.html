...
&nbsp;
    const templateFilePath = (() =&gt; {
      if (meta.body !== undefined) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (existsSync(explicitlyDefinedPath)) return explicitlyDefinedPath;
      }
&nbsp;
      const defaultPath = path.join(emailsFolder, path.parse(filePath).name + '.html');
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (existsSync(defaultPath)) return defaultPath;
<span class="cstat-no" title="statement not covered" >      return null;</span>
    })();
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (templateFilePath === null) {
