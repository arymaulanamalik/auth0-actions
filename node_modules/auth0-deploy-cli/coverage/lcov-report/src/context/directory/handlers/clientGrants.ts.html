...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (associatedClient === undefined) <span class="cstat-no" title="statement not covered" >return grant.client_id;</span>
&nbsp;
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (associatedAPI === undefined) <span class="cstat-no" title="statement not covered" >return grant.audience;</span>
&nbsp;
