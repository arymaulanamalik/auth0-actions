    ...
    <div class='pad1'>
        ...
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>74/95</span>
            </div>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { lstatSync, readdirSync, readFileSync, existsSync } from 'fs';
...
&nbsp;
  ...
  if (!config.AUTH0_ACCESS_TOKEN) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!config.AUTH0_CLIENT_ID) <span class="cstat-no" title="statement not covered" >missingParams.push('AUTH0_CLIENT_ID');</span>
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!shouldPreserveKeywords) return;
&nbsp;
    const isKeywordMappingsEmpty =
<span class="cstat-no" title="statement not covered" >      config.AUTH0_KEYWORD_REPLACE_MAPPINGS === undefined ||</span>
      Object.keys(config.AUTH0_KEYWORD_REPLACE_MAPPINGS).length === 0;
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (isKeywordMappingsEmpty) {</span>
...
&nbsp;
    const doLocalFilesExist = <span class="cstat-no" title="statement not covered" >(<span class="fstat-no" title="function not covered" >() =</span>&gt; {</span>
<span class="cstat-no" title="statement not covered" >      if (!existsSync(config.AUTH0_INPUT_FILE)) <span class="cstat-no" title="statement not covered" >return false;</span></span>
&nbsp;
      const isDirectory = <span class="cstat-no" title="statement not covered" >lstatSync(config.AUTH0_INPUT_FILE).isDirectory();</span>
<span class="cstat-no" title="statement not covered" >      if (isDirectory) {</span>
<span class="cstat-no" title="statement not covered" >        return readdirSync(config.AUTH0_INPUT_FILE).length &gt; 0;</span>
      }
<span class="cstat-no" title="statement not covered" >      return existsSync(config.AUTH0_INPUT_FILE);</span>
    })();
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!doLocalFilesExist) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error(</span>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!AUTH0_CLIENT_SECRET &amp;&amp; !AUTH0_CLIENT_SIGNING_KEY_PATH) {
<span class="cstat-no" title="statement not covered" >      throw new Error(</span>
...
&nbsp;
    const clientCredentials = await authClient.clientCredentialsGrant({
      audience: config.AUTH0_AUDIENCE
        ? <span class="branch-0 cbranch-no" title="branch not covered" >config.AUTH0_AUDIENCE</span>
