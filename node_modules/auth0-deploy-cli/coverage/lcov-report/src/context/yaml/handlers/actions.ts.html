...
&nbsp;
  return {
    actions: filteredActions.map((action) =&gt; ({
      ...
      secrets:
        typeof action.secrets === 'string' ? <span class="branch-0 cbranch-no" title="branch not covered" >action.secrets </span>: mapSecrets(action.secrets || <span class="branch-1 cbranch-no" title="branch not covered" >[])</span>, //Enables keyword preservation to operate on action secrets
