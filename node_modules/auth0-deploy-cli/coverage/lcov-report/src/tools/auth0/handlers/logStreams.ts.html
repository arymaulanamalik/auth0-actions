...
<span class="cstat-no" title="statement not covered" >            delete update.sink;</span>
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (update.status === 'suspended') {
...
<span class="cstat-no" title="statement not covered" >            delete update.status;</span>
          }
          return update;
        }),
      };
