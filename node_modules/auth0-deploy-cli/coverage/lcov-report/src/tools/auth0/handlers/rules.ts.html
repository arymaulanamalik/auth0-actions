...
&nbsp;
  async getType(): Promise&lt;Asset[] | null&gt; {
    try {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (isDeprecatedError(err)) {
        return null;
      }
...
&nbsp;
    ...
    const reOrder: Asset[] = futureRules.reduce((accum: Asset[], r: Asset) =&gt; {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (existing === null) <span class="cstat-no" title="statement not covered" >return accum;</span>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (existing === null) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      if (isDeprecatedError(err)) {</span>
